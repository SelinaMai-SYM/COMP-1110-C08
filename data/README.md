...
- eight restaurant archetypes such as bubble tea lounge, dessert cafe, burger hall, ramen bar, family trattoria, Korean BBQ house, dim sum hall, and fine dining tasting room
- queue presets for a single line, balanced size-based queues, coarse bands, and fine-grained bands
